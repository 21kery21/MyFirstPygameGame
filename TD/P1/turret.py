...
class Turret(pg.sprite.Sprite):
  def __init__(self, sprite_sheets, tile_x, tile_y):
    ...
    self.org_range = TURRET_DATA[self.upgrade_level-1].get("range")
    self.cooldown = TURRET_DATA[self.upgrade_level-1].get("cooldown")
    self.org_cooldown = TURRET_DATA[self.upgrade_level-1].get("cooldown")
  ...
  def upgrade(self):
    ...
    self.cooldown = TURRET_DATA[self.upgrade_level-1].get("cooldown")
    self.org_cooldown = TURRET_DATA[self.upgrade_level-1].get("cooldown")
    self.upgrade_cost = TURRET_DATA[self.upgrade_level-1].get("upgrade_cost") - (TURRET_DATA[self.upgrade_level-1].get("upgrade_cost")*self.upgrade_discount)
